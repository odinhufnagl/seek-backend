...
const blockUserController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const r = yield (0, services_1.dbCreate)(userBlocking_1.default, {
    ...
    const r2 = yield (0, services_1.dbUpdate)(models_1.UserChat, { isBlocked: true }, {
        where: {
...
exports.default = { blockUserController };
